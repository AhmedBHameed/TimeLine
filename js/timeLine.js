...
(function($) {
        ...
        $.fn.timeLine = function(prop)
        {
            ...
            $(document).ready(function()
            {
                ...
                {
                    'use strict';
                    var check = /^#[0-9A-F]{3,6}$/i.test(value);
                    if(!check && showMSG)
                        {
                ...
                function init()
                {
                    ...
                    var color = hexToRgbaColor(settings.mainColor)[0], colorNeigbor = hexToRgbaColor(settings.mainColor)[1];
                        ...
                        settings.myTimeLine.find('.item:odd').addClass('wow pull-right '+settings.RightAnimation).attr('data-wow-offset', settings.offset).attr('data-wow-duration', settings.itemAnimateDuration + 's');
